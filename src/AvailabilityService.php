 ...
 *
 * @param boolean  $errorReporting Set if the function should display errors or suppress them, default is false
...
class AvailabilityService
{
    ...
    public function isAvailable($domain)
    {
        ...
        if (gethostbyname($domain) == $domain) {
            ...
            if (isset($this->whois[$tld][0])) {
                $whoisServer = $this->whois[$tld][0];
